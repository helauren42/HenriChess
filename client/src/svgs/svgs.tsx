export const SvgCross = ({ classes }: { classes: string }) => {
  return <svg className={`${classes}`} width="800px" height="800px" viewBox="0 0 25 25" version="1.1" xmlns="http://www.w3.org/2000/svg">
    <title>cross</title>
    ...
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      <g id="Icon-Set-Filled" transform="translate(-469.000000, -1041.000000)" fill="#000000">
